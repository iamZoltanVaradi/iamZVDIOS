...
static NSUInteger __unused USERNAME_MAX_LENGTH = 60;
...
BOOL DIOSIsUserLoggedIn;

NSString *DIOSSessionId;
NSString *DIOSLoggedInUserName;
NSString *DIOSLoggedInUserId;
NSString *DIOSLoggedInUserUniqueId;
NSInteger DIOSLoggedInUserUserPoints;
