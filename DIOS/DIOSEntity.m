...
#pragma mark entityIndex
+ (void)entityIndex:(NSDictionary *)entity
                eid:(NSString*)eId
            success:(void (^)(AFHTTPRequestOperation *operation, id responseObject)) success
            failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error)) failure {
    
    NSString *path = [NSString stringWithFormat:@"%@", eId];
...
/*
 ...
 - (void)indexWithParameters:(NSDictionary *)parameters
 success:(void (^)(AFHTTPRequestOperation *, id))success
 failure:(void (^)(AFHTTPRequestOperation *, NSError *))failure
 {
 NSMutableURLRequest *req = [self.client requestWithMethod:@"GET" path:self.entityType parameters:parameters];
 AFHTTPRequestOperation *op = [self.client HTTPRequestOperationWithRequest:req
 success:success
 failure:failure];
